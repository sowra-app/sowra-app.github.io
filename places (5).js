/* صورة من بلدي — data/places.js
   المناطق والمدن وإحداثياتها */
...
/* الحالة الحية — تندمج مع الأماكن المخصّصة */
export const geo = { GEO: {}, VILL: {}, custom: [] };
...
export function nearestCity(lat, lng){
  ...
  let region = "";
  for(const r in geo.GEO) if(geo.GEO[r].includes(best)){ region = r; break; }
